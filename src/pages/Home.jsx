        ...
        <div className="border-r text-2xl border-[#3a2f26] flex flex-col justify-center gap-8 px-12">
          <div>
            <div className="mb-4">
              ...
              <span className="text-[#E7B96B]">2026/08/28</span>
            </div>
            <div className="mb-2 text-4xl text-[#E7B96B]">Kickoff Meeting</div>
            <div className="mb-2">| Room placeholder - 3:30pm</div>
            <div>
        ...
        <div className="flex flex-col px-12">
          <div className="grid grid-cols-[3fr_2fr] border-b border-[#3a2f26] text-2xl">
            <div className="pr-12 py-12">
              ...
              <div>Bring a laptop or borrow one from the lab cart.</div>
            </div>
          ...
          <div className="grid grid-cols-[3fr_2fr] border-b border-[#3a2f26]  text-2xl">
            <div className="pr-12 py-12">
              <div className="text-[#B5AFA6] mb-4">
                <span className="text-[#7FA396]">$</span> date --{" "}
                <span className="text-[#c9846a]">2026/09/12</span>
              </div>
              <div className="text-4xl text-[#c9846a] mb-2">
                Competition interest Session
              </div>
              <div>Try sample problems and choose a training track.</div>
            </div>
